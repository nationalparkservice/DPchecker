...
> available [Documentation](https://doi-nps.github.io/DPchecker/).

Before you ask a question, it is best to search for existing
[Issues](https://github.com/doi-nps/DPchecker/issues) that might help
...
- Open an
  [Issue](https://github.com/doi-nps/DPchecker/issues/new/choose).
...
- Determine if your bug is really a bug and not an error on your side
  ...
  [documentation](https://doi-nps.github.io/DPchecker/). If you are
...
- To see if other users have experienced (and potentially already
  ...
  tracker](https://github.com/doi-nps/DPchecker/issues/new/choose).
...
- Make sure that you are using the latest version.
- Read the [documentation](https://doi-nps.github.io/DPchecker/)
  carefully and find out if the functionality is already covered, maybe
  by an individual configuration.
- Perform a [search](https://github.com/doi-nps/DPchecker/issues) to see
...
issues](https://github.com/doi-nps/DPchecker/issues).
...
[`pkgdown::build_site_github_pages()`](https://rdrr.io/pkg/pkgdown/man/build_site_github_pages.html)
