...
* Data pacakge metadata contains at least one keyword ([`test_keywords()`](../reference/test_keywords.html))
...
* Metadata do not contain GPS coordinates if the data package is not public ([`test_public_points()`](../reference/test_public_points.hmtl)
